...
개발자 하면 책! 은 떨어질래야 떨어질 수 없는 것 같습니다.  판교 SK플래닛의 개발자-엔지니어분들도 그러한데요. 이번 글은 기술조직 내 작은 '언플러그드' 테크 미니 도서관을 열고 운영을 시작한 이야기입니다. 편하게 보아주세요~ 
...
(구글 나노바나나로 그린 '테미도'의 상상도입니다. 편안해 보이죠? ^^ ~~근데 이건 너무 전기먹게 생겼...~~ )
...
~~생각같아서는 AR기반 사내 맵을 그리고(indoor LBS) OO문고처럼 배달로봇으로 딜리버리해 주는 잉여력을 발휘.. 아 아닙니다.~~


![temido-real_](./temido-real_.png)
(초기 테미도의 모습 - 지금은 더 좋은 책꽂이로 이전 중 ㅎㅎ)
...
이 기간 총 대출 횟수는 63건으로, 휴일을 제외하면 working day 매일 약 1권 대출이 이루어졌다고 볼 수 있습니다. 대부분의 개발팀에서 골고루 대여를 했었고(일부 인프라팀에서도 대여), 사업부서에서도 한 분께서 이름을 적고 빌려가셨었네요 ㅎㅎ 
...
책은 잘 받았구요, 윤리경영팀 검수 직후 바로 테미도에 기증하였습니다 ㅎㅎ
11월 뉴스레터에도 추천도서로 올릴 예정입니다. 
...
이러한 작은 일들이 쌓여 AI 시대에 필요한 한 사람의 개발자가 성장하는 데 기여할 수 있다면 얼마나 좋은 일일까 하는 생각을 하면서 글을 맺고자 합니다. 감사합니다. 