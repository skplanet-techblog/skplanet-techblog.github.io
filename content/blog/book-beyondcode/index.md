...
* 삼각형은 피드백 루프를 형성하며, 삼각형의 중심은 **"지속 가능한 개발자의 성장"** 을 추구

![image03-1](./image03-1.png)
(책에는 없지만지만 이해를 돕기 위해 도식화하였습니다)
...
혹시 다음에 **'코드너머 2편'** 이 나온다면 ^ ^ 1편은 개발자 관점에서의 소프트스킬/브랜딩/문화를 서술했다면, 2편은 IT기업과 담당자 관점에서의 데브렐 업무 및 프랙티스, AI 활용과 해커톤 영역까지 소개하는 관점의 책을 한번 기대해 봅니다(저희도 참전할 수 있으면 좋겠네요 ^ ^).
