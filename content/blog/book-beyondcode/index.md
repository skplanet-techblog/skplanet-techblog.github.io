...
안녕하세요, 오늘은 최근 화제가 되고 있는 개발자 소프트스킬 도서, **"코드 너머, 회사보다 오래 남을 개발자"** 의 요약 및 독후감을 작성하여 보았습니다. 작성하고 보니 성찰/학습/개선이라는 패턴의 **개발자 회고(Retrospect)** 와도 유사한 점이 많은 것 같아요. 나의 업무와 회사의 문화를 회고하는 마음으로 작성해 보았사오니 참고 부탁드립니다. 
