...
const Seo = ({ description, title, children }) => {
  ...
  return (
    <>
      ...
      />
      <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800;900&family=Noto+Sans+KR:wght@400;500;700;900&display=swap" rel="stylesheet"></link>
      {children}
    </>
  );
};
